...
public class CallGraphMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CallGraph callGraph = CallGraph.createCallGraph(projectPath);
            System.out.println(callGraph);

            // Export the call graph to a DOT file
            callGraph.exportToDotFile("callgraph.dot");
            System.out.println("Le graphe d'appels a été exporté dans le fichier callgraph.dot.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
